          ...
          <div class="box bShow">
            ...
            <div class="box-body">
              <table class="table table-striped table-bordered">
                ...
                <tr>
                  <th>Mobile</th>
                  <td><?php if(!empty($getKycData->mobile)){ echo $getKycData->mobile; }else{ echo "NA"; } ?><?php if($getKycData->is_mobileVerified =='Yes'){ ?>
                    <label class="label label-success"><i class="fa fa-check"></i></label>
                    <?php } else { ?>
                      <label class="label label-danger"><i class="fa fa-close"></i></label>
                    <?php } ?></td> 
            ...
            <div class="box-body">
              <table class="table table-striped table-bordered">
                <tr>
                    <td class="text_view text-info" colspan="6"><h4><b>Aadhaar Card Details: </b><h4></td>
                </tr>
                <thead>
                  <thead>
                    <tr>
                      <th>Aadhaar User Name</th>
                      <th>Aadhaar No.</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td colspan="6">
                            <center>No Aadhaar Card Details Available </center>
                        </td>
                    </tr>
                  <?php  }else{ ?>
                    <tr>
                      <td><?= !empty($getKycData->adharUserName)  ? ucwords($getKycData->adharUserName) : 'NA'; ?></td>
                      <td><?= !empty($getKycData->adharCard_no) ? $getKycData->adharCard_no : 'NA'; ?></td>
            ...
            <div class="box-body">
              <table class="table table-striped table-bordered">
                ...
                <thead>
                  ...
                  <?php  }else{ ?>
                    <tr>
                      <td><?= !empty($getKycData->panUserName)  ? ucwords($getKycData->panUserName) : 'NA'; ?></td>
                      <td><?= !empty($getKycData->panCard_no) ? $getKycData->panCard_no : 'NA' ; ?></td>
  ...
  <!-- Aadhar verify Modal -->
    <div class="modal fade" id="aadharVerifyModal" data-modal-color="teal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">  
              <div class="modal-header row">
                <div class="col-md-9"><h4 class="modal-title">Aadhaar Verification Status</h4></div>
                <div class="col-md-3 text-danger">* Required Fields</div>
              </div>     
                  <!-- <form id="updateCpForm" action="<?= site_url('Clients/index') ?>" style="margin-bottom: 0px;"> -->
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-md-12 modal-height">
                          <div class="form-group">
                            <label>Change Aadhaar Status</label> <span class="text-danger">*</span> <span id="errisAadharStatusVerify"></span>
                          ...
                          <div class="form-group" id="aadharRejectStatus" style="display:none;">
                            <label>Aadhaar Rejection Reason</label> <span class="text-danger">*</span> <span id="erraadharRejectionReason"></span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Kyc -  <span> Aadhaar Card</span> </h4>
              </div>
                <div class="modal-body">  
