   ...
   <?php if($getUserChat) { foreach($getUserChat as $row) { ?>
  ...
  <div class="incoming_msg">
    <div class="incoming_msg_img"> 
      ...
      <div class="received_withd_msg">
        ...
        <span class="time_date"> <?php echo date("h:i A",strtotime($row->created));?>   |    <?php echo date("F d",strtotime($row->created));?></span></div>
      </div>
  </div> 
  <?php } else { ?>
