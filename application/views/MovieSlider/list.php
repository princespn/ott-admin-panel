                            ...
                            <tbody>
                                 <?php $index=1; if(!empty($subscription_plan_data))   { foreach ($subscription_plan_data as $subs) { ?>
                                   <tr>
                                      ...
                                      <td><?php echo  $subs->movieId;?></td>
                                       <td><?php echo  $subs->movieName;?></td>
                                      <td><?php echo  $subs->sequence;?>
                                        &nbsp;|&nbsp;
...
<div class="modal fade" id="editPlanModel" role="dialog">
    <div class="modal-dialog">
          <form class="form-horizontal form-label-left" method="post" action="<?php echo site_url();?>/MovieSlider/editSequence" enctype="multipart/form-data"/>
      
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Edit Slider Sequence</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label col-md-4 col-sm- col-xs-12 has-feedback ">Sequence</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
						<input type="hidden" class="form-control has-feedback-left"  name="editId" id="editId">
                        <input type="text" class="form-control has-feedback-left" name="editSequence" id="editcategoryName" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-4 col-sm- col-xs-12 has-feedback ">Movie Id</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        
                        <input type="text" class="form-control has-feedback-left" name="movieId" id="movieId" required>
                    </div>
                </div>                                                              
            </div>
...
function edit_subscription(id) {
		...
		var site_url   = $("#site_url").val();
		var url        =  site_url+"/<?= SLIDERDETAILS; ?>";
