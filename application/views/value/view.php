        ...
        <div class="col-xs-12">
          ...
          <div class="box bShow">
            <div class="box-header">
             ...
             <div class="col-md-4 paddRight"> <a href="<?= site_url(VALUES); ?>"><button type="button" class="btn btn-danger pull-right">Back</button></a></div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-striped table-bordered">
                <tbody>
                    <tr>
                        <td class="text_view"><b>Value</b></td>
                        <td>:</td>
                        <td><?php if(!empty($value)){ echo ucfirst($value); }else{ echo "N/A";} ?></td>
