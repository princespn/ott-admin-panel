      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box bShow">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped" id="adminAmt_datatable" style="width: 100%;">
                <thead>
                <tr>
                  <th>Sr. No.</th>
                  <th>User Name</th>
...
<script type="text/javascript">
  var url = '<?= site_url('AdminAmt/ajax_manage_page'); ?>';
  var actioncolumn=12;
  var pageLength='';
...
<script type="text/javascript">
    ...
    var table = $('#adminAmt_datatable').DataTable({
        "oLanguage": { 
