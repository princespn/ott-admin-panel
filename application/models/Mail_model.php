...
{
	var $column_order = array(null,'mb.mailbodyType','mb.subject','mb.body',null); //set column field database for datatable orderable
    var $column_search = array('mb.mailbodyType','mb.subject','mb.body'); //set column field database for datatable searchable 
    var $order = array('mb.mailBodyId' => 'DESC'); 
