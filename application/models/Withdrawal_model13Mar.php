...
{
	var $column_order = array(null,'u.user_name','u.email_id','u.mobile','d.amount',null,null,'u.balance','d.created','d.status',null); //set column field database for datatable orderable
	var $column_search = array('u.user_name','u.email_id','u.mobile','d.amount','u.balance','d.created','d.status'); //set column field database for datatable searchable 
	...
	{
		$this->db->select('d.*,u.user_id,u.user_name,u.email_id,u.mobile');
		$this->db->from($table); 
