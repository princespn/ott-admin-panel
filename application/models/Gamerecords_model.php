...
class Gamerecords_model extends CI_Model
{
	var $column_order = array('ud.user_name','ud.mobile','ud.balance','ud.signup_date','ud.last_login','ud.blockuser',null); //set column field database for datatable orderable
    var $column_search = array('ud.user_name','ud.mobile','ud.balance','ud.signup_date','ud.last_login','ud.blockuser'); //set column field database for datatable searchable 
